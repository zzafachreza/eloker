      ...
      <View style={{
        ...
        <View style={{
          ...
          <MyMenu onPress={() => {
            ZavalabsScanner.showBarcodeReader(result => {
              ...
              navigation.navigate('AktifitasAdd', result)

            });


          }} img={require('../../assets/A1.png')} judul="Scan Loker" />
          <MyMenu onPress={() => navigation.navigate('Aktifitas')} img={require('../../assets/A2.png')} judul="Daftar Loker" />
        ...
        {user.level == 'Admin' &&
          <View style={{
            ...
            <MyMenu onPress={() => navigation.navigate('Slider')} img={require('../../assets/A4.png')} judul="Master Slider" />
